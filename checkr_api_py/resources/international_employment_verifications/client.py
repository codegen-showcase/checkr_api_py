...
class InternationalEmploymentVerificationsClient:
    ...
    def get(
        ...
        Returns:
            International Employment Verification details
        ...
        Examples:
        ```py
        client.international_employment_verifications.get(id="string")
        ```
        """
...
class AsyncInternationalEmploymentVerificationsClient:
    ...
    async def get(
        ...
        Examples:
        ```py
        await client.international_employment_verifications.get(id="string")
        ```
        """
