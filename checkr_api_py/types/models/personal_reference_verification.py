...
class PersonalReferenceVerification(pydantic.BaseModel):
    """
    ...
    """
    Personal Reference's email address.
    """
    name: typing.Optional[str] = pydantic.Field(alias="name", default=None)
    """
    Personal Reference's full name.
    """
    ...
    questions: typing.Optional[
        typing.List[PersonalReferenceVerificationQuestionsItem]
    ] = pydantic.Field(alias="questions", default=None)
    """
    Array of questions and answers received from Personal Reference.
    """
    relationship: typing.Optional[str] = pydantic.Field(
        alias="relationship", default=None
    )
    """
    Relationship between Candidate and Personal Reference.
    """
