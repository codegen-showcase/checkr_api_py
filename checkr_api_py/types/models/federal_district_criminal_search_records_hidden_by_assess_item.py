...
class FederalDistrictCriminalSearchRecordsHiddenByAssessItem(pydantic.BaseModel):
    """
    ...
    charges_hidden_by_assess: typing.Optional[typing.List[Charge]] = pydantic.Field(
        alias="charges_hidden_by_assess", default=None
    )
    """
    Array of CriminalCharge objects filtered out by your account’s Assess configuration.
    """
