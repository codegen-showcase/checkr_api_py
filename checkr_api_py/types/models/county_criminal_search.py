...
class CountyCriminalSearch(pydantic.BaseModel):
    """
    ...
    """
    County in which the record was recorded.
    """
    estimated_completion_date: typing.Optional[str] = pydantic.Field(
        alias="estimated_completion_date", default=None
    )
    """
    Estimated date of completion for the Search.
    """
    estimated_completion_time: typing.Optional[str] = pydantic.Field(
        alias="estimated_completion_time", default=None
    )
    """
    Estimated time of completion for the Search. This estimate will be based on the maximum turnaround time across all counties searched.
    """
    filtered_by_positive_adjudication_records: typing.Optional[
        typing.List[CountyCriminalSearchFilteredByPositiveAdjudicationRecordsItem]
    ...
    """
    records: typing.Optional[typing.List[CountyCriminalSearchRecordsItem]] = (
    ...
    """
    State in which the record was recorded.
    """
