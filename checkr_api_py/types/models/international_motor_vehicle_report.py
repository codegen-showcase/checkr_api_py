...
class InternationalMotorVehicleReport(pydantic.BaseModel):
    """
    ...
    """
    ISO 3166-2 country code of the jurisdiction where the search was run
    """
    license_reports: typing.Optional[typing.List[LicenseReport]] = pydantic.Field(
        alias="license_reports", default=None
    )
    """
    Array of LicenseReport objects
    """
