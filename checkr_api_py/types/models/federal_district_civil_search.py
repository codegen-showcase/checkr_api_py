...
class FederalDistrictCivilSearch(pydantic.BaseModel):
    """
    ...
    filtered_by_positive_adjudication_records: typing.Optional[
        typing.List[FederalDistrictCivilSearchFilteredByPositiveAdjudicationRecordsItem]
    ...
    """
    records: typing.Optional[typing.List[FederalDistrictCivilSearchRecordsItem]] = (
    ...
    records_hidden_by_assess: typing.Optional[
        typing.List[FederalDistrictCivilSearchRecordsHiddenByAssessItem]
