...
class GlobalWatchlistSearchRecordsItemChargesItem(pydantic.BaseModel):
    """
    ...
    arrest_date: typing.Optional[str] = pydantic.Field(
    ...
    defendant: typing.Optional[str] = pydantic.Field(alias="defendant", default=None)
    ...
    sentence_date: typing.Optional[str] = pydantic.Field(
