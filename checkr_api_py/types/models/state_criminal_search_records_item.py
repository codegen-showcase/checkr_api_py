...
class StateCriminalSearchRecordsItem(pydantic.BaseModel):
    """
    ...
    court_jurisdiction: typing.Optional[typing.Any] = pydantic.Field(
    ...
    file_date: typing.Optional[typing.Any] = pydantic.Field(
        alias="file_date", default=None
    )
    ...
    charges: typing.Optional[typing.List[StateCriminalSearchRecordsItemChargesItem]] = (
        pydantic.Field(alias="charges", default=None)
    )
