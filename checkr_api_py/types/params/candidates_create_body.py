...
class CandidatesCreateBody(typing_extensions.TypedDict):
    """
    ...
    """
    The candidate postal address is the address Checkr will use to send postal mail to the candidate. Each candidate can be associated with only one postal address.
    """
...
class _SerializerCandidatesCreateBody(pydantic.BaseModel):
    """
    Serializer for CandidatesCreateBody handling case conversions
