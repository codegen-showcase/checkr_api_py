...
def test_create_200_success_all_params():
    """Tests a POST request to the /reports/{report_id}/candidate_stories endpoint.
    ...
    response = client.reports.candidate_stories.create(
...
async def test_await_create_200_success_all_params():
    ...
    response = await client.reports.candidate_stories.create(
        content="Since my case, I have received the following certifications (see attachments)",
        documents=[
            {
                "filename": "evidence_of_rehab.pdf",
